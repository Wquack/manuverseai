        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-accent/10 border border-accent/30 rounded-full px-4 py-2"
            >
              <Icon name="Flag" size={16} className="text-accent" />
              <span className="text-accent font-medium text-sm">Made in India • Indigenous AI Technology</span>
            </motion.div>
          ...
          >
            <div className="relative w-96 h-96">
              ...
              >
                <div className="w-48 h-48 bg-gradient-cyan rounded-full flex items-center justify-center shadow-glow relative">
                  <Icon name="Zap" size={64} color="#0A1628" strokeWidth={2.5} />
              ...
              {[0, 72, 144, 216, 288]?.map((rotation, index) => (
                ...
                >
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-4">
                    <div className="w-8 h-8 bg-primary/40 rounded-full flex items-center justify-center backdrop-blur-sm">
